<div class="span-8 last">
	...
	<?php if(get_theme_option('video') != '') {
    		...
    		<div class="sidebarvideo">
    			...
    			<object width="290" height="220"><param name="movie" value="<?php echo get_theme_option('video'); ?>"></param>
    				<param name="allowFullScreen" value="true"></param>
    				<param name="allowscriptaccess" value="always"></param>
    				<embed src="<?php echo get_theme_option('video'); ?>" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="290" height="220"></embed>
    			</object>
    			</li>
    			</ul>
    		</div>
