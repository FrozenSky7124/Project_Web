...
<?php if ( function_exists("has_post_thumbnail") && has_post_thumbnail() ) { the_post_thumbnail(array(660,200), array("class" => "alignleft post_thumbnail")); } ?>
				...
				<div class="postmeta"><img src="<?php bloginfo('template_url'); ?>/images/comments.png" /><?php comments_popup_link('木有评论...&nbsp;&nbsp; | &nbsp;&nbsp;', '评论：1条 &nbsp;&nbsp; | &nbsp;&nbsp;', '评论：%条 &nbsp;&nbsp; | &nbsp;&nbsp;'); ?><?php if(get_the_tags()) { ?> <img src="<?php bloginfo('template_url'); ?>/images/tag.png" /> <?php  the_tags('标签： ', ', '); } ?>   
<div style="float:right"><?php  if(function_exists('the_views')) { the_views(); } ?></div>
</div>
